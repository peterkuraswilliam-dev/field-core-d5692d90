...
export const Field = forwardRef<
  HTMLInputElement,
  InputHTMLAttributes<HTMLInputElement> & { label: string; error?: string; trailing?: ReactNode }
    ...
    <Button variant="secondary" onClick={onClick} loading={loading} type="button">
      {!loading && (
        <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden>
          ...
          <path
            fill="#FF3D00"
            d="M6.3 14.7l6.6 4.8C14.7 16 19 13 24 13c3 0 5.8 1.1 7.9 3l5.7-5.7C34 6.4 29.3 4.5 24 4.5c-7.7 0-14.3 4.4-17.7 10.2z"
          />
          <path
            fill="#4CAF50"
            d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.1C29.2 35 26.8 36 24 36c-5.3 0-9.7-3.1-11.3-7.9l-6.5 5C9.6 39.5 16.3 44 24 44z"
          />
          <path
            fill="#1976D2"
            d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4 5.5l6.2 5.1C41 34.3 44 29.6 44 24c0-1.2-.1-2.3-.4-3.5z"
          />
        </svg>
      )}
